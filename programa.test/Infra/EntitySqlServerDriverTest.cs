...
[TestClass]
public class EntitySqlServerDriverTest
{
    ...
    public async Task Startup()
    {
        ...
        await new EntitySqlServerDriver<Cliente>(this.caminhoArquivoTest).ExcluirTudo();
        await new EntitySqlServerDriver<ContaCorrente>(this.caminhoArquivoTest).ExcluirTudo();
    }
    ...
    {
        var jsonDriver = new EntitySqlServerDriver<Cliente>(this.caminhoArquivoTest);
    ...
    {
        var jsonDriver = new EntitySqlServerDriver<ContaCorrente>(this.caminhoArquivoTest);
